...
# Notes
# - Gemini pointed out something interesting, which is for very unbalanced arrays, the expected time for a binary search approach might be better

# https://gemini.google.com/app/a9b9924bfbcd90ea

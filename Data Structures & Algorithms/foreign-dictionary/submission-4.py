...
# BUGS
# - Had a bug when len(words) was 1 initially and I wasn't doing the specific check
# - Hadn't considered if the order was invalid because of the prefix shenanigan (didn't have the early return in the method where we create the graph)
class Solution:

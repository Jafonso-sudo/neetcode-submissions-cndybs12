...
# Notes
# - Very interesting problem, solved it by myself, but I needed to submit and get cases first
# - I solved the crux quickly (the realizing the monotonic stack), but had not realized the keeping track of the width

# Interview Mock: https://gemini.google.com/app/925f58e92eb3c364
